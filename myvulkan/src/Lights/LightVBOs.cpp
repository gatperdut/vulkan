...
void LightVBOs::internalCreateBuffers(VkBuffer *vBuffer, VkDeviceMemory *vBufferMemory, VkBuffer *iBuffer, VkDeviceMemory *iBufferMemory, std::vector<LightVertex> vertices, std::vector<uint32_t> indices) {
...
void LightVBOs::createBuffers(std::vector<LightVertex> vertices, std::vector<uint32_t> indices) {
