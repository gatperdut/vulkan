...
void PipelinesHandler::createGraphicsPipeline() {
	...
	viewport.x = 0.0f;
	viewport.y = 0.0f;
	viewport.width = (float)swapchainHandler->extent.width;
	viewport.height = (float)swapchainHandler->extent.height;
	viewport.minDepth = 0.0f;
	viewport.maxDepth = 1.0f;

	VkRect2D scissor = {};
	scissor.offset = { 0, 0 };
	scissor.extent = swapchainHandler->extent;
	...
	pipelineLayoutInfo.pSetLayouts = &descriptorsHandler->descriptorSetLayout;
