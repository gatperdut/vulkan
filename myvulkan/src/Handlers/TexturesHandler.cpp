...
#include "Handlers/TexturesHandler.h"
#include "buffers.h"
#include "images.h"
...
void TexturesHandler::createTextureImage() {
...
void TexturesHandler::createTextureImageView() {
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
};


void TexturesHandler::createTextureSampler() {
