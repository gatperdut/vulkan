...
void ShadowVBOs::internalCreateBuffers(VkBuffer *vBuffer, VkDeviceMemory *vBufferMemory, VkBuffer *iBuffer, VkDeviceMemory *iBufferMemory, std::vector<ShadowVertex> vertices, std::vector<uint32_t> indices) {
...
void ShadowVBOs::createBuffers(std::vector<ShadowVertex> vertices, std::vector<uint32_t> indices) {
